...
def makeTrainer(
    *,
    ...
    lr=1e-3,
    device="cuda",
    split={"train": -1, "val": 10000},
    net_config={"k": 512, "num_layers": 4},
    log_level="info",
    trainer_config={"log_dir": None, "log_args": {"minPeriod": 0.02, "timeFrac": 0.2}},
    save=False
):
    ...
    dataloaders["Train"] = islice(
        dataloaders["train"], 0, None, 10
    )  # for logging subsample dataset by 5x
