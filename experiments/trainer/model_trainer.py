...
class RegressorPlus(Regressor):
    ...
    def __init__(self, model, *args, **kwargs):
        ...
        self.gradvals = objax.Jit(
            objax.GradValues(fastloss, model.vars()), model.vars()
        )
    ...
    def metrics(self, loader):
        mse = lambda mb: np.asarray(
            jax.device_get(jnp.mean((self.model.predict(mb[0]) - mb[1]) ** 2))
        )
    ...
    def logStuff(self, step, minibatch=None):
        ...
        )  # subsample by 5x so it doesn't take too long
